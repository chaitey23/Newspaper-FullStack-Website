...
//     const goldHover = '#b48a52';
//     const goldLight = '#fef8f0';
...
//                     {/* Main Spinner */}
//                     <div
//                         className="w-16 h-16 border-4 border-amber-200 rounded-full animate-spin mx-auto mb-4"
//                         style={{ borderTopColor: goldColor }}
//                     ></div>

//                     {/* Outer Pulse Effect */}
//                     <div
//                         className="absolute inset-0 w-16 h-16 border-4 border-transparent rounded-full animate-ping mx-auto"
//                         style={{ borderColor: goldColor, opacity: 0.3 }}
//                     ></div>
//                 </div>
//                 <p className="text-lg font-semibold text-gray-700 mt-4">Loading Premium Articles</p>
//                 <p className="text-sm text-gray-500 mt-2">Please wait while we fetch exclusive content for you</p>
...
//                     onMouseOver={(e) => e.target.style.backgroundColor = goldHover}
//                     onMouseOut={(e) => e.target.style.backgroundColor = goldColor}
//                 >
//                     Try Again
//                 </button>
//             </div>
...
//                                 <Link
//                                     to={`/article/${article._id}`}
//                                     className="inline-flex items-center justify-center w-full text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-md"
//                                     style={{ backgroundColor: goldColor }}
//                                     onMouseOver={(e) => e.target.style.backgroundColor = goldHover}
//                                     onMouseOut={(e) => e.target.style.backgroundColor = goldColor}
//                                 >
